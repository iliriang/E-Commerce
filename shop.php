      ...
      <section class="featured section" id="shop">
        ...
        <div class="featured__container bd-grid">
          <article class="sneaker">
            <img src="assets/img/AirMax.png" alt="" class="sneaker__img" />
            <br />
            <span class="sneaker__name">Nike Motion 2</span>
            <span class="sneaker__preci">$99.99</span>
            <a href="nike-airmax.php" class="button-light"
              >Add to Cart <i class="bx bxs-right-arrow-alt button-icon"></i
            ></a>
          </article>
          <article class="sneaker">
            <img src="assets/img/AirMax2.png" alt="" class="sneaker__img" />
            <br />
            <span class="sneaker__name">Nike Motion 2</span>
            <span class="sneaker__preci">$99.99</span>
            <a href="nike-airmax.php" class="button-light"
    ...
    <footer class="footer section">
      <div class="footer__container bd-grid">
        <div class="footer__box">
          <h3 class="footer__title">OmiO</h3>
        ...
        <div class="footer__box">
          ...
          <ul>
            ...
            <li>
              <a href="index.php#featured" class="footer__link">Featured</a>
            </li>
            <li><a href="index.php#women" class="footer__link">Women</a></li>
            <li><a href="index.php#new" class="footer__link">New</a></li>
          </ul>
        </div>
      ...
      <p class="footer__copy">
        &#169; 2021 Ilirian Gerxhaliu & Eror Ferizi. All right reserved
      </p>
    </footer>
